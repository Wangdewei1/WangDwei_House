...
function changeAllIds(a) {
    ...
    $("#resumeId").val(b.resumeId.n), c = b.expId, d = b.eduId, e = b.projectId, f = b.showId, $("#workExperience .wlist li").each(function () {
...
!function (a, b) {
    ...
    var n,
        f = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
        g = /^([\-+])=\s*(\d+\.?\d*)/, h = [{
        ...
        }, k = {"byte": {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, l = i.support = {},
        m = a("<p>")[0], o = a.each;
    m.style.cssText = "background-color:rgba(1,1,1,.5)", l.rgba = m.style.backgroundColor.indexOf("rgba") > -1, o(j, function (a, b) {
        ...
        parse: function (e, f, g, h) {
            ...
            var d = i(a), e = d._space(), f = j[e], g = 0 === this.alpha() ? i("transparent") : this,
                h = g[f.cache] || f.to(g._rgba), l = h.slice();
        ...
        $(".projectForm").each(function () {
            $(this).validate({
                ...
                submitHandler: function (a) {
                    var b = $('input[name="projectName"]', a).val(), c = $('input[name="thePost"]', a).val(),
                        e = $('input[name="projectYearStart"]', a).val(),
                        f = $('input[name="projectMonthStart"]', a).val(),
                        g = $('input[name="projectYearEnd"]', a).val(), h = $('input[name="projectMonthEnd"]', a).val(),
                        i = "项目描述" != $('textarea[name="projectDescription"]', a).val() ? $('textarea[name="projectDescription"]', a).val() : "",
                        j = $(".projectId", a).val(), l = $("#resumeId").val(), m = $("#resubmitToken").val();
            ...
            $(this).validate({
                ...
                submitHandler: function (a) {
                    var b = "请输入作品链接" != $('input[name="workLink"]', a).val() ? $('input[name="workLink"]', a).val() : "",
                        ...
                        d = $(".showId", a).val(), e = $("#resumeId").val(), f = $("#resubmitToken").val();
                    $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                        ...
                        var c, d, e;
                        $("#resubmitToken").val(b.resubmitToken), b.success ? (c = "", d = "", e = b.content.workShow, 3 == b.code ? "" != e ? (c += '<li data-id="' + e.id + '"><div class="workList c7">' + '<i class="sm_del dn"></i>' + '<i class="sm_edit dn"></i>', e.url && (d = "http://" == e.url.substring(0, 7) || "https://" == e.url.substring(0, 8) ? e.url : "http://" + e.url, c += '<div class="f16">网址：<a href="' + d + '" >' + e.url + "</a></div>"), c += "<p>" + e.workName + "</p>" + "</div></li>", placeholderFn(), "" != $.trim(h.obj.children(".workShow").children(".slist").html()) && $(a).remove(), h.obj.children(".workShow").children(".slist").prepend(c), h.obj.children(".workShow").removeClass("dn"), h.obj.children(".workEdit").addClass("dn"), h.obj.children(".c_add").removeClass("dn")) : "" != $.trim(h.obj.children(".workShow").children(".slist").html()) ? ($(a).remove(), h.obj.children(".c_add").removeClass("dn")) : (h.obj.children(".workEdit").addClass("dn"), h.obj.children(".workAdd").removeClass("dn")) : 4 == b.code ? (c += '<div class="workList c7"><i class="sm_del dn"></i><i class="sm_edit dn"></i>', e.url && (d = "http://" == e.url.substring(0, 7) || "https://" == e.url.substring(0, 8) ? e.url : "http://" + e.url, c += '<div class="f16">网址：<a href="' + d + '" >' + e.url + "</a></div>"), c += "<p>" + e.workName + "</p>" + "</div>", placeholderFn(), $(a).parent("li").html(c)) : 2 == b.code && ($(a).parent("li").remove(), "" == $.trim(h.obj.children(".workShow").children(".slist").html()) && h.AddCancel), h.obj.find(".slist li:last-child").addClass("noborder"), $("#lastChangedTime span").text(b.content.refreshTime), $("#resumeScore .which div").text(b.content.infoCompleteStatus.msg), $("#resumeScore .which span").attr("rel", b.content.infoCompleteStatus.nextStage), scoreChange(b.content.infoCompleteStatus.score), k(h.obj), b.content.isNew && changeAllIds(b.content.jsonIds)) : alert(b.msg), $(a).find(":submit").val("保 存").attr("disabled", !1)
                    })
                }
            })
        })
    ...
    */
    ...
    $(".profile_radio li input").click(function () {
        ...
        var c = $(b).parents(".experienceForm"), d = c.find(".companyYearStart").val(),
            e = c.find(".companyMonthStart").val(), f = c.find(".companyYearEnd").val(),
            g = c.find(".companyMonthEnd").val();
        return d > f ? !1 : d == f && e > g ? !1 : !0
    }, "开始时间需早于结束时间"), jQuery.validator.addMethod("checkProjectYear", function (a, b) {
        var c = $(b).parents(".projectForm"), d = c.find(".projectYearStart").val(),
            e = c.find(".projectMonthStart").val(), f = c.find(".projectYearEnd").val(),
            g = c.find(".projectMonthEnd").val();
        return d > f ? !1 : d == f && e > g ? !1 : !0
    }, "开始时间需早于结束时间"), jQuery.validator.addMethod("checkSchoolYear", function (a, b) {
        var c = $(b).parents(".educationalForm"), d = c.find(".schoolYearStart").val(),
        ...
        submitHandler: function (a) {
            var b = $('input[name="resumeName"]', a).val(), c = $("#resumeId").val();
        ...
        var a = $("#nameVal").val(), b = $("#genderVal").val(), c = $("#topDegreeVal").val(),
            d = $("#workyearVal").val(), e = $("#currentStateVal").val(), f = $("#emailVal").val(),
            g = $("#telVal").val();
        ...
        a.stopPropagation();
        var b = $(this).text();
        $("#select_topDegree").val(b).css("color", "#333").removeClass("select_focus"), $("#topDegree").val(b), $("#box_topDegree").hide(), $("#profileForm").validate().element($("#topDegree"))
        ...
        a.stopPropagation();
        var b = $(this).text();
        $("#select_workyear").val(b).css("color", "#333").removeClass("select_focus"), $("#workyear").val(b), $("#box_workyear").hide(), $("#profileForm").validate().element($("#workyear"))
        ...
        a.stopPropagation();
        var b = $(this).text();
        $("#select_currentState").val(b).css("color", "#333").removeClass("select_focus"), $("#currentState").val(b), $("#box_currentState").hide(), $("#profileForm").validate().element($("#currentState"))
        ...
        submitHandler: function (a) {
            var c = $('input[name="expectCity"]', a).val(), d = $('input[name="type"]:checked', a).val(),
                e = "期望职位，如：产品经理" != $('input[name="expectPosition"]', a).val() ? $('input[name="expectPosition"]', a).val() : "",
                f = $('input[name="expectSalary"]', a).val(), g = $("#resumeId").val(), h = $("#resubmitToken").val();
            $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
        ...
        Edit: function (a) {
            ...
            a.parent("li").find("img").attr("src"), h = a.parent("li").find("h3").text(), i = a.parent("li").find("h4").text(), this.obj.children(".experienceShow").find(".companyName").val(i), this.obj.children(".experienceShow").find(".positionName").val(h), this.obj.children(".experienceShow").find(".companyYearStart").val(c), this.obj.children(".experienceShow").find(".select_companyYearStart").css("color", "#333").val(c), this.obj.children(".experienceShow").find(".companyMonthStart").val(e), this.obj.children(".experienceShow").find(".select_companyMonthStart").css("color", "#333").val(e), this.obj.children(".experienceShow").find(".companyYearEnd").val(d), this.obj.children(".experienceShow").find(".select_companyYearEnd").css("color", "#333").val(d), this.obj.children(".experienceShow").find(".companyMonthEnd").val(f), this.obj.children(".experienceShow").find(".select_companyMonthEnd").css("color", "#333").val(f), this.obj.children(".experienceShow").find(".expId").val(b), this.obj.children(".experienceShow").children(".experienceForm").show(), "至今" == $.trim(f) && this.obj.children(".experienceShow").find(".select_companyMonthEnd").unbind("click"), this.companyNameVal = i, this.positionNameVal = h, this.companyYearStartVal = c, this.companyMonthStartVal = e, this.companyYearEndVal = d, this.companyMonthEndVal = f, this.obj.children(".c_add").addClass("dn"), j(this.obj)
        },
        Del: function (a) {
        ...
        $(this).validate({
            ...
            messages: {
                companyName: {required: "请输入有效的公司名称，如：拉勾网", maxlenStr: "请输入有效的公司名称，如：拉勾网"},
                positionName: {
            ...
            submitHandler: function (a) {
                var b = $('input[name="companyName"]', a).val(), d = $('input[name="positionName"]', a).val(),
                    e = $('input[name="companyYearStart"]', a).val(), f = $('input[name="companyMonthStart"]', a).val(),
                    g = $('input[name="companyYearEnd"]', a).val(), h = $('input[name="companyMonthEnd"]', a).val(),
                    i = $(".expId", a).val(), j = $("#resumeId").val(), l = $("#resubmitToken").val();
                $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
        ...
        obj: $("#projectExperience"), resetForm: function () {
            ...
            var m, b = a.parents("li"), c = b.attr("data-id"), d = b.find("div.f16").attr("data-proName"),
                f = b.find("div.f16").attr("data-posName"), g = b.find("div.f16").attr("data-startY"),
                h = b.find("div.f16").attr("data-startM"), i = b.find("div.f16").attr("data-endY"),
                k = b.find("div.f16").attr("data-endM"), l = b.find(".dl1").html();
        ...
        Edit: function (a) {
            var b = a.parent("li").attr("data-id"), c = a.siblings("span").attr("data-startY"),
                d = a.siblings("span").attr("data-endY"), e = a.parent("li").find("h4").attr("data-degree"),
                f = a.parent("li").find("h4").attr("data-proName"), g = a.parent("li").find("h3").attr("data-schName");
        ...
        Del: function (a) {
            var b = a.parent("li").attr("data-id");
            $.ajax({url: ctx + "/educationExperience/delEdu.json", type: "POST", data: {id: b}}).done(function (b) {
        ...
        $(this).validate({
            ...
            submitHandler: function (a) {
                var b = $('input[name="schoolName"]', a).val(), c = $('input[name="degree"]', a).val(),
                    d = $('input[name="professionalName"]', a).val(), e = $('input[name="schoolYearStart"]', a).val(),
                    g = $('input[name="schoolYearEnd"]', a).val(), h = $(".eduId", a).val(), i = $("#resumeId").val(),
                    j = $("#resubmitToken").val();
                $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
        ...
        rules: {selfDescription: {required: !1}}, submitHandler: function (a) {
            var b = $('textarea[name="selfDescription"]', a).val(), c = $("#resumeId").val(),
                d = $("#resubmitToken").val();
            $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
