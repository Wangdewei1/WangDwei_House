...
<%--                                    <a class="collection_link"  href="javascript:void(0);">${deliver.result}</a>--%>
                                    <a class="collection_link"  href="javascript:void(0);"><c:if test="${deliver.audit==0}">未审核</c:if></a>
                                    <a class="collection_link"  href="javascript:void(0);"><c:if test="${deliver.audit==1}">通过审核</c:if></a>
                                    <a class="collection_link"  href="javascript:void(0);"><c:if test="${deliver.audit==2}">初试</c:if></a>
                                    <a class="collection_link"  href="javascript:void(0);"><c:if test="${deliver.audit==3}">复试</c:if></a>
                                    <a class="collection_link"  href="javascript:void(0);"> <c:if test="${deliver.audit==4}">offer</c:if></a>
                                    <a class="collection_link"  href="javascript:void(0);"><c:if test="${deliver.audit==9}">未通过</c:if></a>
                                        <i></i>
                                    <a class="collection_link"  href="javascript:void(0);"><s:message code="liebiao.message3"/></a>
                                </li>
                            </ul>
                            </c:forEach>
                        </form>
