    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <h1>
                    <em></em>
                <s:message code="toudi.message13"/> </h1>
                </dt>
                    ...
                    <form id="searchForm">
                        ...
                        <ul class="reset my_jobs">
                            <li data-id="149594">
                                ...
                                <div> ${deliver.sex}/ ${deliver.major}/ ${deliver.education}</div>
                                <div class="links">
                                    <a  class="job_edit" href="<%=Const.ROOT%>download?filename=${deliver.resume}"><s:message code="toudi.message2"/></a>
                                    <a  class="job_edit" href="<%=Const.ROOT%>deliver/doupdate3?id=${deliver.id}">下一环节</a>
                                    <a  class="job_edit" href="<%=Const.ROOT%>deliver/doupdate9?id=${deliver.id}">终止流程</a>
                                </div>
                            </li>
                        </ul>
                        </c:forEach>
