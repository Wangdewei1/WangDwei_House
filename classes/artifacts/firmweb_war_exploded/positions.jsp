...
<head>
    ...
    <title><s:message code="list.message3"/></title>
    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <h1>
                    <em></em>
                   <s:message code="positions.message1"/> </h1>
                </dt>

                <dd>
                    <form id="searchForm">
                        <c:forEach var="post" items="${requestScope.posts}" varStatus="status">
                        <ul class="reset my_jobs">
                            <li data-id="149594">
                                <h3>
                                    <a   href="javascript:void(0)">${post.post}</a>
                                </h3>
                                <div> ${post.num}人 / ${post.salary}/ ${post.education}</div>
                                <div class="links">
                                    <a class="job_edit" href="<%=Const.ROOT%>post/toupdate?id=${post.id}"><s:message code="positions.message2"/></a>
                                    <a class="job_del" href="<%=Const.ROOT%>post/dodelete?id=${post.id}"><s:message code="positions.message3"/></a>
                                </div>
                            </li>
                        </ul>
                        </c:forEach>
